...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ABORT, MPI_Comm_f2c(*comm));
    call_start(call);
    call_end(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ACCUMULATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ADD_ERROR_CLASS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ADD_ERROR_CODE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ADD_ERROR_STRING, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ADDRESS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLGATHER, MPI_Comm_f2c(*comm));
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IALLGATHER, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
    add_network(call, sendcount, &sendtype_f2c, MPI_ALL, recvcount, &recvtype_f2c, MPI_ALL);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLGATHERV, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IALLGATHERV, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
    add_network(call, sendcount, &sendtype_f2c, MPI_ALL, recvcounts, &recvtype_f2c, MPI_ALLV);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLOC_MEM, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLREDUCE, MPI_Comm_f2c(*comm));
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IALLREDUCE, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, MPI_ALL, count, &datatype_f2c, MPI_ALL);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLTOALL, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
    add_network(call, sendcount, &sendtype_f2c, MPI_ALL, recvcount, &recvtype_f2c, MPI_ALL);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IALLTOALL, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
    add_network(call, sendcount, &sendtype_f2c, MPI_ALL, recvcount, &recvtype_f2c, MPI_ALL);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLTOALLV, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IALLTOALLV, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
    add_network(call, sendcounts, &sendtype_f2c, MPI_ALLV, recvcounts, &recvtype_f2c, MPI_ALLV);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ALLTOALLW, MPI_Comm_f2c(*comm));
    int i;
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IALLTOALLW, MPI_Comm_f2c(*comm));
    int i;
    call_start(call);
    CNTD_Group_t *group = call->cntd_comm->cntd_group;
    MPI_Datatype sendtypes_f2c[group->size], recvtypes_f2c[group->size];
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ATTR_DELETE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ATTR_GET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ATTR_PUT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_BARRIER, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IBARRIER, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_BCAST, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_BSEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IBCAST, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == *root)
        add_network(call, count, &datatype_f2c, MPI_ALL, NULL, NULL, MPI_NONE);
    else
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_BSEND_INIT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_BUFFER_ATTACH, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_BUFFER_DETACH, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CANCEL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_COORDS, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_CREATE, MPI_Comm_f2c(*old_comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_GET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_MAP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_RANK, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_SHIFT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CART_SUB, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CARTDIM_GET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_CLOSE_PORT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_ACCEPT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_CALL_ERRHANDLER, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_COMPARE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_CONNECT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_CREATE_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_CREATE_KEYVAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_CREATE_GROUP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_CREATE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_DELETE_ATTR, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_DISCONNECT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_DUP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_IDUP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_DUP_WITH_INFO, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_FREE_KEYVAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_FREE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_GET_ATTR, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_DIST_GRAPH_CREATE, MPI_Comm_f2c(*comm_old));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_DIST_GRAPH_CREATE_ADJACENT,  MPI_Comm_f2c(*comm_old));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_DIST_GRAPH_NEIGHBORS, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_DIST_GRAPH_NEIGHBORS_COUNT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_GET_ERRHANDLER, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_GET_INFO, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_GET_NAME, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_GET_PARENT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_GROUP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_JOIN, MPI_Comm_f2c(*intercomm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_RANK, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_REMOTE_GROUP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_REMOTE_SIZE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SET_ATTR, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SET_ERRHANDLER, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SET_INFO, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SET_NAME, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SIZE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SPAWN, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SPAWN_MULTIPLE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SPLIT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_SPLIT_TYPE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMM_TEST_INTER, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_COMPARE_AND_SWAP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_DIMS_CREATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ERRHANDLER_CREATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ERRHANDLER_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ERRHANDLER_GET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ERRHANDLER_SET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ERROR_CLASS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ERROR_STRING, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_EXSCAN, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FETCH_AND_OP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IEXSCAN, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_CALL_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_CREATE_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SET_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_OPEN, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_CLOSE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_DELETE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SET_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_PREALLOCATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_GROUP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_AMODE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SET_INFO, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_INFO, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SET_VIEW, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_VIEW, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SEEK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_POSITION, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_BYTE_OFFSET, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SEEK_SHARED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_POSITION_SHARED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_READ_AT_ALL_END, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_WRITE_AT_ALL_END, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_READ_ALL_END, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_WRITE_ALL_END, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_READ_ORDERED_END, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_WRITE_ORDERED_END, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_TYPE_EXTENT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SET_ATOMICITY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_GET_ATOMICITY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FILE_SYNC, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FINALIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_FREE_MEM, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GATHER, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IGATHER, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
		add_network(call, NULL, NULL, MPI_NONE, recvcount, &recvtype_f2c, MPI_ALL);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GATHERV, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IGATHERV, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
		add_network(call, NULL, NULL, MPI_NONE, recvcounts, &recvtype_f2c, MPI_ALLV);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_ADDRESS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_COUNT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_ELEMENTS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_ELEMENTS_X, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET, MPI_COMM_WORLD);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_ACCUMULATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_LIBRARY_VERSION, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_PROCESSOR_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GET_VERSION, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GRAPH_CREATE, MPI_Comm_f2c(*comm_old));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GRAPH_GET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GRAPH_MAP, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GRAPH_NEIGHBORS_COUNT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GRAPH_NEIGHBORS, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GRAPHDIMS_GET, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GREQUEST_COMPLETE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GREQUEST_START, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_COMPARE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_DIFFERENCE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_EXCL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_INCL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_INTERSECTION, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_RANGE_EXCL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_RANGE_INCL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_RANK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_TRANSLATE_RANKS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_GROUP_UNION, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IBSEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, *dest, NULL, NULL, MPI_NONE);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IMPROBE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IMRECV, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_CREATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_DELETE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_DUP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_GET, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_GET_NKEYS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_GET_NTHKEY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_GET_VALUELEN, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INFO_SET, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INIT_THREAD, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INTERCOMM_CREATE, MPI_Comm_f2c(*local_comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INTERCOMM_MERGE, MPI_Comm_f2c(*intercomm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IPROBE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IRECV, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IRSEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, *dest, NULL, NULL, MPI_NONE);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ISEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, *dest, NULL, NULL, MPI_NONE);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ISSEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, *dest, NULL, NULL, MPI_NONE);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IS_THREAD_MAIN, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_KEYVAL_CREATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_KEYVAL_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_LOOKUP_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_MPROBE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_MRECV, MPI_COMM_WORLD);
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_NEIGHBOR_ALLGATHER, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INEIGHBOR_ALLGATHER, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_NEIGHBOR_ALLGATHERV, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INEIGHBOR_ALLGATHERV, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_NEIGHBOR_ALLTOALL, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INEIGHBOR_ALLTOALL, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_NEIGHBOR_ALLTOALLV, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INEIGHBOR_ALLTOALLV, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_NEIGHBOR_ALLTOALLW, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_INEIGHBOR_ALLTOALLW, MPI_Comm_f2c(*comm));
    // network
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_OP_COMMUTATIVE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_OP_CREATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_OPEN_PORT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_OP_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PACK_EXTERNAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PACK_EXTERNAL_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PACK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PACK_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PCONTROL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PROBE, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PUBLISH_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_PUT, MPI_COMM_WORLD);
    if(call->cntd_comm->rank == *target_rank)
    {
        MPI_Datatype target_datatype_f2c = MPI_Type_f2c(*target_datatype);
        add_network(call, NULL, NULL, MPI_NONE, target_count, &target_datatype_f2c, *target_rank);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_QUERY_THREAD, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RACCUMULATE, MPI_COMM_WORLD);
    if(call->cntd_comm->rank == *target_rank)
    {
        MPI_Datatype target_datatype_f2c = MPI_Type_f2c(*target_datatype);
        add_network(call, NULL, NULL, MPI_NONE, target_count, &target_datatype_f2c, *target_rank);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RECV_INIT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RECV, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, NULL, NULL, MPI_NONE, count, &datatype_f2c, *source);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REDUCE, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == *root)
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IREDUCE, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == *root)
		add_network(call, NULL, NULL, MPI_NONE, count, &datatype_f2c, MPI_ALL);
	else
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REDUCE_LOCAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REDUCE_SCATTER, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == ROOT_MPI)
        add_network(call, recvcounts, &datatype_f2c, MPI_ALLV, recvcounts, &datatype_f2c, MPI_ALLV);
    else
        add_network(call, &recvcounts[call->cntd_comm->rank], &datatype_f2c, ROOT_MPI, &recvcounts[call->cntd_comm->rank], &datatype_f2c, ROOT_MPI);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IREDUCE_SCATTER, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == ROOT_MPI)
        add_network(call, recvcounts, &datatype_f2c, MPI_ALLV, recvcounts, &datatype_f2c, MPI_ALLV);
    else
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REDUCE_SCATTER_BLOCK, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == ROOT_MPI)
        add_network(call, recvcount, &datatype_f2c, MPI_ALL, recvcount, &datatype_f2c, MPI_ALLV);
    else
        add_network(call, recvcount, &datatype_f2c, ROOT_MPI, recvcount, &datatype_f2c, ROOT_MPI);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_IREDUCE_SCATTER_BLOCK, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    if(call->cntd_comm->rank == ROOT_MPI)
        add_network(call, recvcount, &datatype_f2c, MPI_ALL, recvcount, &datatype_f2c, MPI_ALLV);
    else
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REGISTER_DATAREP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REQUEST_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_REQUEST_GET_STATUS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RGET, MPI_COMM_WORLD);
    if(call->cntd_comm->rank == *target_rank)
    {
        MPI_Datatype origin_datatype_f2c = MPI_Type_f2c(*origin_datatype);
        add_network(call, origin_count, &origin_datatype_f2c, *target_rank, NULL, NULL, MPI_NONE);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RGET_ACCUMULATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RPUT, MPI_COMM_WORLD);
    if(call->cntd_comm->rank == *target_rank)
    {
        MPI_Datatype target_datatype_f2c = MPI_Type_f2c(*target_datatype);
        add_network(call, NULL, NULL, MPI_NONE, target_count, &target_datatype_f2c, *target_rank);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RSEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, *dest, NULL, NULL, MPI_NONE);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_RSEND_INIT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SCAN, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ISCAN, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SCATTER, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ISCATTER, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
		add_network(call, sendcount, &sendtype_f2c, MPI_ALL, NULL, NULL, MPI_NONE);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SCATTERV, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_ISCATTERV, MPI_Comm_f2c(*comm));
    if(call->cntd_comm->rank == *root)
    {
        MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
		add_network(call, sendcounts, &sendtype_f2c, MPI_ALLV, NULL, NULL, MPI_NONE);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SEND_INIT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
    add_network(call, count, &datatype_f2c, *dest, NULL, NULL, MPI_NONE);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SENDRECV, MPI_Comm_f2c(*comm));
    MPI_Datatype sendtype_f2c = MPI_Type_f2c(*sendtype);
    MPI_Datatype recvtype_f2c = MPI_Type_f2c(*recvtype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SENDRECV_REPLACE, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SSEND_INIT, MPI_Comm_f2c(*comm));
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_SSEND, MPI_Comm_f2c(*comm));
    MPI_Datatype datatype_f2c = MPI_Type_f2c(*datatype);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_START, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_STARTALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_STATUS_SET_CANCELLED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_STATUS_SET_ELEMENTS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_STATUS_SET_ELEMENTS_X, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TESTALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TESTANY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TEST, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TEST_CANCELLED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TESTSOME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TOPO_TEST, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_COMMIT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CONTIGUOUS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_DARRAY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_F90_COMPLEX, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_F90_INTEGER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_F90_REAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_HINDEXED_BLOCK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_HINDEXED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_HVECTOR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_KEYVAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_INDEXED_BLOCK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_STRUCT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_SUBARRAY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_CREATE_RESIZED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_DELETE_ATTR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_DUP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_EXTENT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_FREE_KEYVAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_ATTR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_CONTENTS, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_ENVELOPE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_EXTENT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_EXTENT_X, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_TRUE_EXTENT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_GET_TRUE_EXTENT_X, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_HINDEXED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_HVECTOR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_INDEXED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_LB, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_MATCH_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_SET_ATTR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_SET_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_SIZE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_SIZE_X, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_STRUCT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_UB, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_TYPE_VECTOR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_UNPACK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_UNPUBLISH_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_UNPACK_EXTERNAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WAITALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WAITANY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WAIT, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WAITSOME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_ALLOCATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_ALLOCATE_SHARED, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_ATTACH, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_CALL_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_COMPLETE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_CREATE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_CREATE_DYNAMIC, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_CREATE_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_CREATE_KEYVAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_DELETE_ATTR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_DETACH, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FENCE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FLUSH, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FLUSH_ALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FLUSH_LOCAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FLUSH_LOCAL_ALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FREE, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_FREE_KEYVAL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_GET_ATTR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_GET_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_GET_GROUP, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_GET_INFO, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_GET_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_LOCK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_LOCK_ALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_POST, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_SET_ATTR, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_SET_ERRHANDLER, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_SET_INFO, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_SET_NAME, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_SHARED_QUERY, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_START, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_SYNC, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_TEST, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_UNLOCK, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_UNLOCK_ALL, MPI_COMM_WORLD);
    call_start(call);
...
{
    CNTD_Call_t *call = add_cntd_call(ENUM_MPI_WIN_WAIT, MPI_COMM_WORLD);
    call_start(call);
